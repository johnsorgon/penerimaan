  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Lowongan Yang Anda Apply</h1>
          </div>
          <!-- /.col -->
          <!-- /.col -->
        </div><!-- /.row -->
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <?php 
        $lowongan = mysqli_query($sambung, "SELECT * FROM loker INNER JOIN pelamar ON loker.id_loker=pelamar.id_loker WHERE pelamar.id_akun='".$_SESSION['id_akun']."' ORDER BY loker.created_at_date DESC");
