      ...
      <div class="container-fluid">
        ...
        <div class="card">
                ...
                <div class="card-body">
                  ...
                  <a href="#" class="btn btn-success" data-toggle="modal" data-target="#modal-id">
                  Edit File
                  </a>
                  <a href="hapus_berkas.php?id_berkas=<?php echo $data['id_berkas'];?>" onclick="return confirm('Anda yakin ingin menghapus berkas ini ?')" class="btn btn-danger">
                  Hapus
                  </a>
                </div>
                <!-- /.card-body -->
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form role="form" enctype="multipart/form-data" action="edit_berkas.php" method="POST">
                  <div class="form-group">
                    <label>ID Berkas</label>
                    <input type="text" class="form-control" name="id_berkas" value="<?php echo $data['id_berkas'];?>" readonly>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control"  name="ttl" value="<?php echo $data['tempat_tl'];?>" required>
                  </div>
                  <div class="form-group">
                    <label>Agama</label>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Masukkan Alamat" name="alamat" value="<?php echo $data['alamat'];?>" required>
                  </div>
                  <div class="form-group">
                    <label >Nomor HP</label>
                    <input type="text" class="form-control" placeholder="Masukkan Nomor HP" name="hp" value="<?php echo $data['nomor_hp'];?>" required>
                  </div>
                  <div class="form-group">
                    <label>Email</label>
                    <input type="email" class="form-control" placeholder="Masukkan Email" name="email" value="<?php echo $data['email'];?>" required>
                  </div>
                  <div class="form-group">
                    <label>*Note SKCK</label>
                    <input type="text" class="form-control" name="note" value="<?php echo $data['comment_skck'];?>">
                  </div>
                <!-- /.card-body -->
            </div>
      ...
      <div class="modal fade" id="modal-id">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form role="form" enctype="multipart/form-data" action="edit_file.php" method="POST">
                  <div class="form-group">
                    <label>ID Berkas</label>
                    <input type="text" class="form-control" name="id_berkas" value="<?php echo $data['id_berkas'];?>" readonly>
                  </div>
                  <div class="form-group">
                    <label>Pilih File Yang Diedit</label>
                    <select class="form-control" name="kolom" required>
                    <option value="">--PILIH FILE--</option>
                    <option value="file_foto">File Foto</option>
                    <option value="file_ijasah">File Ijasah</option>
                    <option value="file_ktp">File KTP</option>
                    <option value="file_kk">File Kartu Keluarga</option>
                    <option value="file_skck">File SKCK</option>
                    <option value="file_inovasi">File Inovasi</option>
                    </select>
                  </div>
                  <div class="form-group">
